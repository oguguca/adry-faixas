export const TRUST_ITEMS = [
  ...
  { value: "Produção própria", label: "acompanhamento de perto" },
  { value: "Sob medida", label: "material e formato para cada projeto" },
  { value: "São Paulo", label: "atendimento direto" },
];
